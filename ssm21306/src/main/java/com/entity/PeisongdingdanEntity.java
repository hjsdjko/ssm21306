...
public class PeisongdingdanEntity<T> implements Serializable {
	 ...
	 * 设置：配送内容
	 */
	public void setPeisongneirong(String peisongneirong) {
		this.peisongneirong = peisongneirong;
	}
	/**
	 * 获取：配送内容
	 */
	public String getPeisongneirong() {
		return peisongneirong;
	}
	/**
	 * 设置：工号
	 */
