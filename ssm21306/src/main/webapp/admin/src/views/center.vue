  ...
  <div>
    ...
    >  
     <el-row>
      ...
      <el-col :span="12">
        <el-form-item   v-if="flag=='qishou'"  label="工号" prop="gonghao">
          <el-input v-model="ruleForm.gonghao" readonly              placeholder="工号" clearable></el-input>
        </el-form-item>
      </el-col>
      <el-col :span="12">
        <el-form-item   v-if="flag=='qishou'"  label="骑手姓名" prop="qishouxingming">
          <el-input v-model="ruleForm.qishouxingming"               placeholder="骑手姓名" clearable></el-input>
        </el-form-item>
      </el-col>
      <el-col :span="12">
        <el-form-item v-if="flag=='qishou'"  label="性别" prop="xingbie">
          <el-select v-model="ruleForm.xingbie" placeholder="请选择性别">
            <el-option
      ...
      <el-col :span="24">  
        <el-form-item v-if="flag=='qishou'" label="头像" prop="touxiang">
          <file-upload
          tip="点击上传头像"
          action="file/upload"
          :limit="3"
      ...
      <el-col :span="12">
        <el-form-item   v-if="flag=='qishou'"  label="电话" prop="dianhua">
...
export default {
  ...
  methods: {
    ...
    onUpdateHandler() {
      ...
      if((!this.ruleForm.gonghao)&& 'qishou'==this.flag){
        this.$message.error('工号不能为空');
        return
      }
      if((!this.ruleForm.mima)&& 'qishou'==this.flag){
        this.$message.error('密码不能为空');
        return
      }
      if( 'qishou' ==this.flag && this.ruleForm.dianhua&&(!isMobile(this.ruleForm.dianhua))){
