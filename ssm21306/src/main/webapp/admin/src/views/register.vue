  ...
  <div>
    <div class="container">
      <div class="login-form" style="backgroundColor:rgba(255, 255, 255, 0.26);borderRadius:10px">
        <h1 class="h1" style="color:rgba(255, 255, 255, 1);fontSize:28px;">外卖商城平台的微信小程序注册</h1>
		<el-form ref="rgsForm" class="rgs-form" :model="rgsForm" label-width="120px">
			...
			<!-- <div v-if="tableName=='qishou'" class="input-group">
			   <div class="label">工号</div>
			   <div class="input-container">
			     <input v-model="ruleForm.gonghao" class="input" type="text" placeholder="工号">
			   </div>
			 </div> -->
			<el-form-item label="工号" class="input" v-if="tableName=='qishou'">
			...
			<el-form-item label="密码" class="input" v-if="tableName=='qishou'">
			  <el-input v-model="ruleForm.mima" autocomplete="off" placeholder="密码" type="password"#elsetype="text" />
			</el-form-item>
			<!-- <div v-if="tableName=='qishou'" class="input-group">
			   <div class="label">骑手姓名</div>
			   <div class="input-container">
			     <input v-model="ruleForm.qishouxingming" class="input" type="text" placeholder="骑手姓名">
			   </div>
			 </div> -->
			<el-form-item label="骑手姓名" class="input" v-if="tableName=='qishou'">
			  <el-input v-model="ruleForm.qishouxingming" autocomplete="off" placeholder="骑手姓名"  />
			</el-form-item>
			<!-- <div v-if="tableName=='qishou'" class="input-group">
			...
			<el-form-item label="电话" class="input" v-if="tableName=='qishou'">
