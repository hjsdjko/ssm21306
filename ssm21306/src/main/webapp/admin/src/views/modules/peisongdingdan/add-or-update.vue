<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="配送费" prop="peisongfei">
          <el-input v-model="ruleForm.peisongfei" 
              placeholder="配送费" clearable  :readonly="ro.peisongfei"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="配送费" prop="peisongfei">
              <el-input v-model="ruleForm.peisongfei" 
                placeholder="配送费" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="购买日期" prop="goumairiqi">
          <el-input v-model="ruleForm.goumairiqi" 
              placeholder="购买日期" clearable  :readonly="ro.goumairiqi"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="购买日期" prop="goumairiqi">
              <el-input v-model="ruleForm.goumairiqi" 
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="骑手姓名" prop="qishouxingming">
          <el-input v-model="ruleForm.qishouxingming" 
              placeholder="骑手姓名" clearable  :readonly="ro.qishouxingming"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="骑手姓名" prop="qishouxingming">
              <el-input v-model="ruleForm.qishouxingming" 
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="配送内容" prop="peisongneirong">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="配送内容"
                  v-model="ruleForm.peisongneirong" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.peisongneirong" label="配送内容" prop="peisongneirong">
                    <span>{{ruleForm.peisongneirong}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.zongjiage = true;
          ...
          if(o=='peisongfei'){
            this.ruleForm.peisongfei = obj[o];
	    this.ro.peisongfei = true;
            continue;
          }
          if(o=='goumairiqi'){
	    ...
	    this.ro.peisongzhuangtai = true;
          ...
          if(o=='peisongneirong'){
            this.ruleForm.peisongneirong = obj[o];
	    this.ro.peisongneirong = true;
            continue;
          }
          if(o=='gonghao'){
      ...
      this.$http({
		...
		if(json.qishouxingming!=''&&json.qishouxingming){
          ...
          this.$message.error(data.msg);
            ...
            this.peisongzhuangtaiOptions = "备货中,已取货,配送中,已送达".split(',')
    },
    // 多级联动参数
    info(id) {
      this.$http({
        url: `peisongdingdan/info/${id}`,
        method: "get"
      }).then(({ data }) => {
        if (data && data.code === 0) {
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `peisongdingdan/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.peisongdingdanCrossAddOrUpdateFlag = false;
                  this.parent.search();
