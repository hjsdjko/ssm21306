<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="起送价" prop="qisongjia">
          <el-input v-model="ruleForm.qisongjia" 
              placeholder="起送价" clearable  :readonly="ro.qisongjia"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="起送价" prop="qisongjia">
              <el-input v-model="ruleForm.qisongjia" 
                placeholder="起送价" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
...
export default {
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.faburiqi = true;
          ...
          if(o=='qisongjia'){
            this.ruleForm.qisongjia = obj[o];
	    this.ro.qisongjia = true;
            continue;
          }
          if(o=='peisongfei'){
	...
	this.ruleForm.shangpinxiangqing = this.ruleForm.shangpinxiangqing.replace(reg,'../../../ssm21306/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
