<template>
  <div class="main-content">
      ...
      <div class="table-content">
        <el-table class="tables" :size="contents.tableSize" :show-header="contents.tableShowHeader"
            ...
            <el-table-column width="300" :align="contents.tableAlign"
                ...
                <el-button v-if="isAuth('dingdanxinxi','接单') && contents.tableBtnIcon == 1 && contents.tableBtnIconPosition == 1" type="success" icon="el-icon-tickets" size="mini" @click="peisongdingdanCrossAddOrUpdateHandler(scope.row,'cross')">{{ contents.tableBtnFont == 1?'接单':'' }}</el-button>
                <el-button v-if="isAuth('dingdanxinxi','接单') && contents.tableBtnIcon == 1 && contents.tableBtnIconPosition == 2" type="success" size="mini" @click="peisongdingdanCrossAddOrUpdateHandler(scope.row,'cross')">{{ contents.tableBtnFont == 1?'接单':'' }}<i class="el-icon-tickets el-icon--right" /></el-button>
                <el-button v-if="isAuth('dingdanxinxi','接单') && contents.tableBtnIcon == 0" type="success" size="mini" @click="peisongdingdanCrossAddOrUpdateHandler(scope.row,'cross')">{{ contents.tableBtnFont == 1?'接单':'' }}</el-button>
    ...
    <peisongdingdan-cross-add-or-update v-if="peisongdingdanCrossAddOrUpdateFlag" :parent="this" ref="peisongdingdanCrossaddOrUpdate"></peisongdingdan-cross-add-or-update>
...
export default {
  ...
  methods: {
    ...
    peisongdingdanCrossAddOrUpdateHandler(row,type){
      this.showFlag = false;
