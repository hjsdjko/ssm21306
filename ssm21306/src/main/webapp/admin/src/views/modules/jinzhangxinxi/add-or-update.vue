<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="进账时间" prop="jinzhangshijian">
            <el-date-picker
                value-format="yyyy-MM-dd HH:mm:ss"
                v-model="ruleForm.jinzhangshijian" 
                type="datetime"
                placeholder="进账时间">
            </el-date-picker>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.jinzhangshijian" label="进账时间" prop="jinzhangshijian">
              <el-input v-model="ruleForm.jinzhangshijian" 
                placeholder="进账时间" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      </el-row>
...
export default {
  ...
  created() {
	this.ruleForm.jinzhangshijian = this.getCurDateTime()
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.beizhu = true;
          ...
          if(o=='jinzhangshijian'){
            this.ruleForm.jinzhangshijian = obj[o];
	    this.ro.jinzhangshijian = true;
            continue;
          }
          if(o=='userid'){
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `jinzhangxinxi/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.jinzhangxinxiCrossAddOrUpdateFlag = false;
                  this.parent.search();
