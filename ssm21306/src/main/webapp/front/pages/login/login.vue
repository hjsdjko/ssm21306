<template>
	<view class="content">
		...
		<view class="links">
            ...
            <view>|</view>
                        			            <view class="link-highlight" @tap="onRegisterTap('qishou')" :style='{"color":"rgba(23, 152, 242, 1)","fontSize":"24rpx"}'>注册骑手</view>
            <view>|</view>
